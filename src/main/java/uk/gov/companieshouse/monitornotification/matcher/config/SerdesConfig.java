...
import uk.gov.companieshouse.monitornotification.matcher.serdes.ArrayNodeDeserialiser;
...
public class SerdesConfig {
    ...
    @Bean
    public ArrayNodeDeserialiser<AltCapitalDescriptionValue> altCapitalArrayNodeDeserialiser(ObjectMapper objectMapper) {
